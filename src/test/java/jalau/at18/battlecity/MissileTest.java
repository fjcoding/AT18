...
public class MissileTest {
    ...
    @Test
    public void missileShouldsetPositionUP() {
        missile.pointingWhere = "UP";
        int[][] pointing = missile.setPosition(row1, colum1, row2, colum2);
        int[][] expected = new int[][] {{row1 - 1, colum1}, {row2 - 1, colum2}};
        assertArrayEquals(expected, pointing);
    }

    public void missileShouldsetPositionDown() {
        missile.pointingWhere = "DOWN";
        int[][] pointing = missile.setPosition(row1, colum1, row2, colum2);
        int[][] expected = new int[][] {{row1 + 1, colum1}, {row2 + 1, colum2}};
        assertArrayEquals(expected, pointing);
    }

    public void missileShouldsetPositionLeft() {
        missile.pointingWhere = "LEFT";
        int[][] pointing = missile.setPosition(row1, colum1, row2, colum2);
        int[][] expected = new int[][] {{row1, colum1 - 1}, {row2 - 1, colum2 - 1}};
        assertArrayEquals(expected, pointing);
    }

    public void missileShouldsetPositionRight() {
        missile.pointingWhere = "RIGHT";
        int[][] pointing = missile.setPosition(row1, colum1, row2, colum2);
        int[][] expected = new int[][] {{row1, colum1 + 1}, {row2 - 1, colum2 + 1}};
        assertArrayEquals(expected, pointing);
    }

    // public void isMissilCrashShouldReturTrueWhenUP() {
    // missile.pointingWhere = "UP";
    // row1 = 0;
    // boolean crash = missile.isMissilCrash();
    // // missile.setPosition(0, colum1, row2, colum2);
    // assertEquals(true, crash);
    // }

    // public void isMissilCrashShouldReturTrueWhenDown() {
    // missile.pointingWhere = "DOWN";
    // row1 = 25;
    // boolean crash = missile.isMissilCrash();
    // // missile.setPosition(0, colum1, row2, colum2);
    ...
    // public void isMissilCrashShouldReturTrueWhenLeft() {
    // missile.pointingWhere = "LEFT";
    // colum1 = 0;
    // boolean crash = missile.isMissilCrash();
    // // missile.setPosition(0, colum1, row2, colum2);
    ...
    // public void isMissilCrashShouldReturTrueWhenRight() {
    // missile.pointingWhere = "RIGHT";
    // colum1 = 25;
    // boolean crash = missile.isMissilCrash();
    // // missile.setPosition(0, colum1, row2, colum2);
    ...
    // public void missilCrashShouldReturFalse() {
    // missile.pointingWhere = "UP";
    // missile.isMissilCrash();
    // missile.setPosition(row1, colum1, row2, colum2);
    // assertEquals(false, missile.isMissilCrash());
    // }

    // @Test
    // public void testMoveMissileLeft() {
    // Element[][] missboard = {{empty,empty, empty}, {empty, empty, empty}, {empty,
    ...
    // Element[][] missiboard = {{empty,empty, empty}, {empty, empty, empty},
    ...
    // assertArrayEquals(expected, newBoard);
    // Element[][] missiboard = {{empty,empty, empty, empty}, {empty, empty, empty,
    // empty}, {empty, empty, empty, empty}, {empty, empty,empty, empty}};
