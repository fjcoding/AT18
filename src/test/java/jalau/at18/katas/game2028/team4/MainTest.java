...
public class MainTest {
    ...
    public void moveNumbersUpTest() {
        int[][] matrix = {{0, 0, 0, 0}, {0, NUMBER_TWO, NUMBER_TWO, NUMBER_TWO}, 
			{0, NUMBER_TWO, NUMBER_TWO, NUMBER_TWO}, {NUMBER_TWO, 0, 0, 0}};
        int[][] expectedMatrix = {{NUMBER_TWO, NUMBER_TWO, NUMBER_TWO, NUMBER_TWO}, 
			{0, NUMBER_TWO, NUMBER_TWO, NUMBER_TWO}, {0, 0, 0, 0}, {0, 0, 0, 0}};
        Main main = new Main();
    ...
    public void moveNumbersLeftTest() {
        ...
        int[][] expectedMatrix = {{0, 0, 0, 0}, {NUMBER_TWO, NUMBER_TWO, NUMBER_TWO, 0}, 
			{NUMBER_TWO, NUMBER_TWO, NUMBER_TWO, 0}, {NUMBER_TWO, 0, 0, 0}};
        Main main = new Main();
    ...
    public void moveNumbersRightTest() {
        int[][] matrix = {{0, 0, 0, 0}, {0, 0, NUMBER_TWO, 0}, {0, 0, NUMBER_TWO, 0}, {NUMBER_TWO, 0, 0, 0}};
        int[][] expectedMatrix = {{0, 0, 0, 0}, {0, 0, 0, NUMBER_TWO}, {0, 0, 0, NUMBER_TWO}, {0, 0, 0, NUMBER_TWO}};
        Main main = new Main();
    ...
    public void moveNumbersDownTest() {
        int[][] matrix = {{0, 0, 0, 0}, {0, 0, 0, 0}, {0, NUMBER_TWO, NUMBER_TWO, NUMBER_TWO}, {NUMBER_TWO, 0, 0, 0}};
    ...
    public void putANewNumberOnMatrix() {
        ...
        int[][] expectedMatrix = {{NUMBER_TWO, NUMBER_TWO, NUMBER_TWO, NUMBER_TWO}, {NUMBER_TWO, NUMBER_TWO, NUMBER_TWO, NUMBER_TWO}, 
			{NUMBER_TWO, NUMBER_TWO, NUMBER_TWO, NUMBER_TWO}, {NUMBER_TWO, NUMBER_TWO, NUMBER_TWO, NUMBER_TWO}};
        Main main = new Main();
